...
export interface LandingDictionary {
  ...
  pricing: {
    ...
    calculator: {
      ...
      valueLabel: string;
      presetsLabel: string;
      presets: { key: string; label: string; role: string }[];
      rangeMin: string;
      rangeMax: string;
      starterLabel: string;
      proLabel: string;
  ...
  pt: {
    ...
    pricing: {
      ...
      calculator: {
        ...
        presets: [
          { key: "freelancer", label: "Freelancer", role: "o prestador" },
          { key: "marketplace", label: "Marketplace", role: "o vendedor" },
          { key: "imobiliaria", label: "Imobiliária", role: "o corretor" },
          { key: "b2b", label: "Empresas B2B", role: "o fornecedor" },
        ],
        rangeMin: "R$ 100",
        rangeMax: "R$ 50.000",
  ...
  es: {
    ...
    pricing: {
      ...
      calculator: {
        ...
        presets: [
          { key: "freelancer", label: "Freelancer", role: "el prestador" },
          { key: "marketplace", label: "Marketplace", role: "el vendedor" },
          { key: "imobiliaria", label: "Inmobiliaria", role: "el corredor" },
          { key: "b2b", label: "Empresas B2B", role: "el proveedor" },
        ],
        rangeMin: "R$ 100",
        rangeMax: "R$ 50.000",
        starterLabel: "Starter · 4,5%",
  ...
  en: {
    ...
    pricing: {
      ...
      calculator: {
        ...
        presets: [
          { key: "freelancer", label: "Freelancer", role: "the provider" },
          { key: "marketplace", label: "Marketplace", role: "the seller" },
          { key: "imobiliaria", label: "Real estate", role: "the agent" },
          { key: "b2b", label: "B2B companies", role: "the supplier" },
        ],
        rangeMin: "R$100",
        rangeMax: "R$50,000",
        starterLabel: "Starter · 4.5%",
